...
Source: `pkg/config/env.go`, `.env.example` (project paths; adjust to the target sample app).
...
- 🔗 See the project's security-checklist docs and [infrastructure-rules.md](infrastructure-rules.md)
...
- Config: `pkg/config/env.go`, `.env.example` (project paths)
- Postgres constructor: `pkg/postgres/postgres.go` (project path)
