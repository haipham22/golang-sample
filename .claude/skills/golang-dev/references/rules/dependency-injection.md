...
- **Folder structure & placement:** see the project's clean-architecture rules (or this skill's `../folder-structure.md`) → *bootstrap/*
...
- `clean-architecture.md` (project rules) or this skill's `../folder-structure.md` → *bootstrap/* folder structure & placement
...
- Migration plan: app-specific — if migrating off Wire/errors, follow the project's own migration plan; this skill does not assume a specific plan path.
