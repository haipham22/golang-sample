...
- Project entry points: [`main.go`](../../examples/golang-sample/main.go), [`cmd/root.go`](../../examples/golang-sample/cmd/root.go), [`cmd/serverd.go`](../../examples/golang-sample/cmd/serverd.go)
